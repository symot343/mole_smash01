...
//モグラを叩いたときの音
let smash0 = new Audio("smash.mp3");
let smash1 = new Audio("smash.mp3");
let smash2 = new Audio("smash.mp3");
let smash3 = new Audio("smash.mp3");
let smash4 = new Audio("smash.mp3");
let smash5 = new Audio("smash.mp3");
let smash6 = new Audio("smash.mp3");
let smash7 = new Audio("smash.mp3");
let smash8 = new Audio("smash.mp3");
let smash9 = new Audio("smash.mp3");
let smashCount = 0;
let smash = [smash0, smash1, smash2, smash3, smash4, smash5,smash6, smash7, smash8, smash9];
...
function handleClickOrTouch(e){
    ...
    if ((grid[x][y] >= MoleBase) && (grid[x][y] <= MoleBase + MolePhase)) {
        ...
        drawAll();
        smashCount++;
        if (smashCount==smash.length-1){
            smashCount=0;
        }
        let sound = smash[smashCount];
        sound.play();
    }
}
